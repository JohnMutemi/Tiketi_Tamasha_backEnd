...
Revision ID: 7d60ca8aa846
Revises: 
Create Date: 2024-08-18 15:34:41.881012
...
def upgrade():
    ...
    sa.Column('ticket_type', sa.Enum('Early', 'VIP', 'Regular', name='ticket_types'), nullable=False),
    sa.Column('payment_status', sa.Enum('Pending', 'Verified', name='payment_status'), nullable=False),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_booked_events'))
    )
    ...
    sa.PrimaryKeyConstraint('event_id', 'category_id', name=op.f('pk_event_categories'))
    )
